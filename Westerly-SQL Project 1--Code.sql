...
#25.Give the customer id and their respective productid
 ...
 #29.Show all the orderID and respective required date by Customer
 Select OrderID,RequiredDate from salesemployees left outer join orders on
 salesemployees.EmployeeID=Orders.EmployeeID;
 
 #30.FInd out the total revenue generated from product,where the productID=77?
Select sum(unitprice*quantity) as Total_Revenue from orderdetailes where ProductID=77;

#31.Call out the orderdetailes using stores procedure
call Order_Detailes;

#32.Show all the Orders handled by a particular EmployeeID?
